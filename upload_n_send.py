...
thisToken = '3AAABLbl****** ACCESS TOKEN OR INTEGRATION KEY HERE ******3EfgELfnS1rzdwxL' # your access token or integration key
fpath = './fileToSend.pdf' # path to file
tname = 'star_wars.pdf' # transient doc name
myShard = 'na4' # the "shard" your account is on
senderEmail = 'sender@example.com' # email address of sender or token owner
recipt_email = 'recipient-email@example.com' # email address of recipient
...
print(f'Agreement with ID: {new_ag_id} was sent to {recipt_email}. \n\nPlease have {recipt_email} check their inBox!')
